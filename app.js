...
const DEFAULT_DATA = {
  notizie: [
    { id: 1, titolo: "Iscrizioni aperte per la stagione 2026/27", data: "2026-03-12", corpo: "Le iscrizioni per la prossima stagione calcistica sono ora aperte. Contattare la segreteria per maggiori informazioni." },
    { id: 2, titolo: "Nuovi orari allenamenti primavera 2026", data: "2026-03-10", corpo: "A partire da lunedì 15 marzo cambieranno gli orari degli allenamenti per alcune categorie. Consultare la tabella aggiornata." }
  ],
  eventi: [],
  partite: [
    { id: 1,  squadra: "Allievi 2010",           data: "2026-03-29", ora: "10:30", casa: "Polisportiva Voghera",          ospite: "Pinarolese",                    luogo: "Campo Sportivo Voghera",   tipo: "prossima" },
    { id: 2,  squadra: "Giovanissimi 2012",       data: "2026-03-29", ora: "10:00", casa: "Pinarolese",                    ospite: "Aquilotti Pavia",               luogo: "Campo Sportivo Bressana",  tipo: "prossima" },
    { id: 3,  squadra: "Esordienti 2013",         data: "2026-03-28", ora: "16:45", casa: "Pinarolese",                    ospite: "Oltrepo",                       luogo: "Campo Sportivo Pinarolo Po", tipo: "prossima" },
    { id: 4,  squadra: "Esordienti 2014/A",       data: "2026-03-28", ora: "10:00", casa: "Pinarolese",                    ospite: "Cassolese",                     luogo: "Campo Sportivo Pinarolo Po", tipo: "prossima" },
    { id: 5,  squadra: "Esordienti 2014/B",       data: "2026-03-28", ora: "14:00", casa: "APOS",                          ospite: "Pinarolese",                    luogo: "Campo Sportivo Stradella", tipo: "prossima" },
    { id: 6,  squadra: "Pulcini 2015",            data: "2026-03-28", ora: "15:15", casa: "Pinarolese",                    ospite: "Mortara",                       luogo: "Campo Sportivo Pinarolo Po", tipo: "prossima" },
    { id: 7,  squadra: "Pulcini 2016",            data: "2026-03-28", ora: "11:15", casa: "Pinarolese",                    ospite: "Vigevano Accademia",            luogo: "Campo Sportivo Pinarolo Po", tipo: "prossima" },
    { id: 8,  squadra: "Primi Calci 2017",        data: "2026-03-28", ora: "10:00", casa: "Casteggio",                     ospite: "Pinarolese",                    luogo: "Campo Sportivo Verretto",  tipo: "prossima" },
    { id: 9,  squadra: "Primi Calci 2018 A",      data: "2026-03-28", ora: "14:00", casa: "Pinarolese",                    ospite: "APOS Salice",                   luogo: "Campo Sportivo Pinarolo Po", tipo: "prossima" },
    { id: 10, squadra: "Primi Calci 2018 B",      data: "2026-03-28", ora: "14:00", casa: "Polisportiva Voghera",          ospite: "Pinarolese",                    luogo: "Campo Sportivo Voghera",   tipo: "prossima" },
    { id: 11, squadra: "Piccoli Amici 2019-2020", data: "2026-03-28", ora: "11:15", casa: "Pinarolese",                    ospite: "Polisportiva Il Caggio Gioia",  luogo: "Campo Sportivo Pinarolo Po", tipo: "prossima" }
  ],
  squadre: [
...
function renderHome() {
  // Home mostra solo hero + banner squadra preferita.
  // Le notizie sono state rimosse dalla home, si leggono nella pagina Notizie.
  renderFavHomeBanner();
}
...
function renderAltro() {
  document.getElementById('altro-content').innerHTML = `
    ...
    <div class="altro-card" id="sezione-Contatti">
      <div class="altro-card-header" onclick="toggleAltroCard(this)">
        <h3 style="display:flex;align-items:center;gap:8px">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--azzurro)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81 19.79 19.79 0 01.22 2.18a2 2 0 012-2.17h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92z"/></svg>
          Contatti
        </h3>
        <svg class="altro-card-chevron" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
      </div>
        ...
        <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:14px">
          ...
          <div style="display:flex;align-items:center;gap:10px;font-size:14px">
            ...
            <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
              ...
              <a href="tel:3382581122" style="display:inline-flex;align-items:center;gap:5px;text-decoration:none;color:white;font-size:11px;font-weight:600;background:var(--arancione);padding:5px 10px;border-radius:20px">
                <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81 19.79 19.79 0 01.22 2.18a2 2 0 012-2.17h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92z"/></svg>
                338 258 1122
              </a>
            </div>
          </div>
          <div style="display:flex;align-items:center;gap:10px;font-size:14px">
            ...
            <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
              ...
              <a href="tel:3939337697" style="display:inline-flex;align-items:center;gap:5px;text-decoration:none;color:white;font-size:11px;font-weight:600;background:var(--arancione);padding:5px 10px;border-radius:20px">
                <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81 19.79 19.79 0 01.22 2.18a2 2 0 012-2.17h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92z"/></svg>
                393 933 7697
              </a>
            </div>
          ...
          <div style="margin-bottom:4px">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap">
              ...
              ${s.telefono ? `<a href="tel:${s.telefono.replace(/\s/g,'')}" style="display:inline-flex;align-items:center;gap:6px;text-decoration:none;color:#16a34a;font-size:13px;font-weight:600;background:rgba(22,163,74,0.12);padding:7px 13px;border-radius:20px">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#16a34a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81 19.79 19.79 0 01.22 2.18a2 2 0 012-2.17h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92z"/></svg>
                Chiama
              </a>` : ''}
            </div>
          </div>`).join('')}
      ...
      <div class="altro-card-body">
        ...
        ${Array.isArray(DATA.collaborazioni) ? DATA.collaborazioni.map(c => `
          <div class="collab-item">
            ...
            ${c.telefono ? `<div class="sponsor-info" style="font-size:12px;margin-bottom:4px"><svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 4h4l2 5-2.5 1.5a11 11 0 005 5L15 13l5 2v4a2 2 0 01-2 2A16 16 0 013 6a2 2 0 012-2z"/></svg> ${c.telefono}</div>` : ''}
